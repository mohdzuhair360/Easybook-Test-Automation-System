...
namespace TestBuyBusLiveMYR
{
    ...
    public class bus
    {
        ...
        public void GoToURL()
        {
            try
            {
                string urlSgNibongMelaka =
                   "https://www.easybook.com/en-my/bus/booking/sungainibong-to-melakasentral";
                string urlMelakaSgNibong =
                    "https://www.easybook.com/en-my/bus/booking/melakasentral-to-sungainibong";
                string urlKovanMelaka =
                   "https://www.easybook.com/en-my/bus/booking/kovanhub206-to-melakasentral";
        ...
        public void SelectTrip()
        {
            try
            {
                //new WebDriverWait(driver, TimeSpan.FromSeconds(10)).Until(ExpectedConditions.ElementExists((By.LinkText("Select Seats")))).Click();
                ...
                //Thread.Sleep(3000);
                //*[@id="MY-int-19726847-b2fc9930-d60e-4f07-a1af-6a1abdc1bbed"]/div[1]/div[5]/a
